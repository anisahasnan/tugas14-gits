...
import com.example.tugas14_anisahasna.adapter.SliderOnBoardAdapter;
...
public class OnBoardingActivity extends AppCompatActivity {
    ...
    SliderOnBoardAdapter sliderOnBoardAdapter;
    TextView[] dots;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Call adapter
        sliderOnBoardAdapter = new SliderOnBoardAdapter(this);
        viewPager.setAdapter(sliderOnBoardAdapter);
